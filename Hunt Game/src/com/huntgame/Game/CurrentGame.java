...
public class CurrentGame extends Activity {
	Animation rotation;
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if (GamePlayerStatusArr.get(arg2).equals("Pending")) {
					i = new Intent(CurrentGame.this, ViewGameRequestPage.class);

				} else {

					i = new Intent(CurrentGame.this, ViewGameDetails.class);
	...
	class LoadDataJson extends AsyncTask<Void, Integer, Void> {
		...
		Dialog dialog = new Dialog(CurrentGame.this);
		...
		protected void onPreExecute() {
			...
			rotation = AnimationUtils.loadAnimation(CurrentGame.this,
		...
		protected Void doInBackground(Void... params) {
			...
			System.out.println("view game" + StaticValues.UrlLink
		...
		try {
			...
			for (int i = 0; i < array.length(); i++) {
				...
				if (jobjsub.has("request_status")) {
					...
					GamePlayerStatusArr
							.add(jobjsub.getString("request_status"));
